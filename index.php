...
include 'connect.php';
    ...
    $article = $_POST['article'];
     ...
     $sql = "INSERT INTO article (email,article,dtime) VALUES ('$email','$article',NOW())";
...
<html lang="en">
  ...
  <div class="container-fluid ">
    ...
    <div class="container">
        <form class="d-flex align-items-center flex-column " action="/GETPOST/index.php " method="POST">
        <div class="mb-3  w-75">
